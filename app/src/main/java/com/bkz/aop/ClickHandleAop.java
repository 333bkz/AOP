...
import com.bkz.aop.util.FastClickUtil;
...
public class ClickHandleAop {
    private static final String TAG = "ClickHandleAop";
    ...
    public void onClickListener(ProceedingJoinPoint joinPoint) throws Throwable {
        if (FastClickUtil.isFastClick()) {
            Toast.makeText((Context) joinPoint.getThis(), "isFastClick", Toast.LENGTH_SHORT).show();
        } else {
            joinPoint.proceed();
